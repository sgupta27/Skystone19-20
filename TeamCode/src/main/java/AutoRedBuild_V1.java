...
public class AutoRedBuild_V1 extends LinearOpMode
{
    ...
    public void runOpMode()
    {
        ...
        holo.driveStraight_Inches(32, .8);
        holo.platformGrab();
        sleep(700);
        holo.driveStraight_Inches(-31, .8);
        holo.platformRelease();
        holo.driveStrafe_Inches(-32, .8);
        holo.driveStraight_Inches(21, .8);
        holo.driveStrafe_Inches(6,.8);
        holo.driveStrafe_Inches(-6,.8);
        holo.driveStraight_Inches(-18,.8);
        holo.driveStrafe_Inches(-21,.8);
    }
}
